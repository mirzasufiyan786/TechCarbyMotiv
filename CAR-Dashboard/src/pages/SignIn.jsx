  ...
  return (
    <main className='min-h-screen flex justify-center items-center bg-gray-100'>
      <div className='bg-transparent w-full md:w-[50%] space-y-4 p-4 md:p-8 pt-12'>
        <div>
          <h1 className='text-[30px] font-bold text-customGray-dark1'>Get started.</h1>
          <h2 className='md:text-xl text-[18px] text-customGray-dark3'>Don't have an account? <span className='text-secondaryP '>
        ...
        <div className='flex flex-col md:flex-row gap-2'>
          <div className='h-[60px] flex w-full md:w-[246px] bg-white border-[1px] border-[#B1B5C3] rounded-lg text-customGray-dark1 font-semibold items-center justify-center gap-2 text-[16px]'>
            ...
            <h1 className='text-[16px]'>Sign in with Google</h1>
          </div>
        ...
        <div className='flex items-center gap-2'>
          <span className='h-[1px] w-[48%] bg-[#B1B5C3]'></span>
          ...
          <form className='space-y-3'>
            <div className='flex flex-col'>
              <label className='flex flex-col'>
                ...
                <input type="text" name="email" placeholder='mirza@gmail.com' className='p-3 h-[50px] w-full rounded-lg bg-white border-[1px] border-[#B1B5C3]' />
              </label>
            </div>
            <div className='flex flex-col'>
              <label className='flex flex-col'>
            ...
            <div className='flex items-start  justify-between'>
              <div className="flex items-center mb-4">
                <input id="default-checkbox" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-[#B1B5C3] cursor-pointer rounded-xl" />
              ...
              <span className='text-secondaryP  md:text-[16px] text-[16px]'>Forgot your password?</span>
            </div>
            <div className='w-full h-[50px] rounded-lg text-white  flex items-center justify-center cursor-pointer bg-secondaryP text-[20px] font-semibold'>
              Sign In
            </div>
          </form>
        </div>
